...
/**
 * check_current_directory - check if command
 * exists in the current directory
 * @params: parameters
 * Return: string of valid path to command file,
 * NULL if not found
...
/**
 * search_in_path - search for command in
...
/**
 * get_file - get correct path to a
 * command file
 * @params: parameters
 * Return: string of valid path to
 * command file, NULL if not found
 * The string needs to be freed
 */
